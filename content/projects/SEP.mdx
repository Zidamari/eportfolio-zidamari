...
![Design of handles](/public/images/Sketch1.jpeg){: style="max-width: 100%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;"}

![More Sketches](/public/images/Sketch2.jpeg){: style="max-width: 100%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;"}

![Relative Use of Product](/public/images/Sketch3.jpeg){: style="max-width: 100%; height: auto; display: block; margin: 0 auto; margin-bottom: 20px;"} <br>
